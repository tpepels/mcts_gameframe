...
public class Board implements IBoard {
    ...
    private int nextRow(int r, int c, int dir) { 
        switch(dir) { 
            case 1: return r-1;  // northeast
            case 2: return r;    // east
            case 3: return r+1;  // southeast
            case 4: return r+1;  // southwest
            case 5: return r;    // west
            case 6: return r-1;  // northwest
        }
    ...
    private int nextCol(int r, int c, int dir) { 
        switch(dir) { 
            case 1: return (r % 2 == 1 ? (c+1) : (c));   // northeast
            case 2: return c+1;                          // east
            case 3: return (r % 2 == 1 ? (c+1) : (c));   // southeast
            case 4: return (r % 2 == 1 ? (c) : (c-1));   // southwest
            case 5: return c-1;                          // west
            case 6: return (r % 2 == 1 ? (c) : (c-1));   // northwest
        }
